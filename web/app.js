...
function compareInventorySnapshots(base, target) {
  ...
  const fields = [
    ...
    { label: "Ethernet NetMode", path: "inventory.Ethernet.netMode" },
    { label: "Primary Interface", path: "inventory.Ethernet.primaryInterface" },
    { label: "Active Interface", path: "inventory.Ethernet.activeInterface" },
    { label: "Port 1A Status", path: "inventory.Ethernet.interfaceStatus.1A.Raw" },
    { label: "Port 1B Status", path: "inventory.Ethernet.interfaceStatus.1B.Raw" },
